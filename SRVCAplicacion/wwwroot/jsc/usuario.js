...
async function mostrarParaEditar() {
    ...
    users.forEach(usuario => {
        ...
        row.innerHTML = `
                ...
                <td><input type="text" value="${usuario.id_punto_control}" data-id="${usuario.id_usuario}" data-field="punto"/></td>
...
async function editUsuario(id) {
    ...
    const auditoria = {
        ...
        detalles: "Usuario con ID ${id} fue editado."
    };

    console.log('Datos enviados:', usuario, 'Auditoria:', auditoria);
